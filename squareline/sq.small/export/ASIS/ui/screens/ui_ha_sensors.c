...
void ui_ha_sensors_screen_init(void)
{
    ...
    lv_obj_set_height(ui_sensor1_btn, 80);
    ...
    lv_obj_set_align(ui_sensor1_logo, LV_ALIGN_LEFT_MID);
    ...
    lv_obj_set_x(ui_sensor1_label, 50);
    ...
    lv_obj_set_width(ui_sensor1_data, LV_SIZE_CONTENT);   /// 100
    lv_obj_set_height(ui_sensor1_data, LV_SIZE_CONTENT);    /// 0
    lv_obj_set_x(ui_sensor1_data, -60);
    lv_obj_set_y(ui_sensor1_data, -5);
    lv_obj_set_align(ui_sensor1_data, LV_ALIGN_BOTTOM_RIGHT);
    ...
    lv_obj_set_x(ui_sensor1_unit, 0);
    lv_obj_set_y(ui_sensor1_unit, -5);
    lv_obj_set_align(ui_sensor1_unit, LV_ALIGN_BOTTOM_RIGHT);
    ...
    lv_obj_set_height(ui_sensor2_btn, 80);
    lv_obj_set_x(ui_sensor2_btn, 22);
    lv_obj_set_y(ui_sensor2_btn, 182);
    ...
    lv_obj_set_align(ui_sensor2_logo, LV_ALIGN_LEFT_MID);
    ...
    lv_obj_set_x(ui_sensor2_label, 50);
    lv_obj_set_y(ui_sensor2_label, 0);
    ...
    lv_obj_set_width(ui_sensor2_data, LV_SIZE_CONTENT);   /// 100
    lv_obj_set_height(ui_sensor2_data, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_sensor2_data, -60);
    lv_obj_set_y(ui_sensor2_data, -5);
    lv_obj_set_align(ui_sensor2_data, LV_ALIGN_BOTTOM_RIGHT);
    ...
    lv_obj_set_x(ui_sensor2_unit, 0);
    lv_obj_set_y(ui_sensor2_unit, -5);
    lv_obj_set_align(ui_sensor2_unit, LV_ALIGN_BOTTOM_RIGHT);
    ...
    lv_obj_set_height(ui_sensor3_btn, 80);
    ...
    lv_obj_set_align(ui_sensor3_logo, LV_ALIGN_LEFT_MID);
    ...
    lv_obj_set_x(ui_sensor3_label, 50);
    lv_obj_set_y(ui_sensor3_label, 0);
    ...
    lv_obj_set_width(ui_sensor3_data, LV_SIZE_CONTENT);   /// 100
    lv_obj_set_height(ui_sensor3_data, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_sensor3_data, -60);
    lv_obj_set_y(ui_sensor3_data, -5);
    lv_obj_set_align(ui_sensor3_data, LV_ALIGN_BOTTOM_RIGHT);
    ...
    lv_obj_set_x(ui_sensor3_unit, 0);
    lv_obj_set_y(ui_sensor3_unit, -5);
    lv_obj_set_align(ui_sensor3_unit, LV_ALIGN_BOTTOM_RIGHT);
    lv_label_set_text(ui_sensor3_unit, "ppb");
    ...
    lv_obj_set_height(ui_sensor4_btn, 80);
    lv_obj_set_x(ui_sensor4_btn, 22);
    lv_obj_set_y(ui_sensor4_btn, 354);
    ...
    lv_obj_set_align(ui_sensor4_logo, LV_ALIGN_LEFT_MID);
    ...
    lv_obj_set_x(ui_sensor4_label, 50);
    lv_obj_set_y(ui_sensor4_label, 0);
    ...
    lv_obj_set_width(ui_sensor4_data, LV_SIZE_CONTENT);   /// 80
    lv_obj_set_height(ui_sensor4_data, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_sensor4_data, -60);
    lv_obj_set_y(ui_sensor4_data, -5);
    lv_obj_set_align(ui_sensor4_data, LV_ALIGN_BOTTOM_RIGHT);
    ...
    lv_obj_set_width(ui_sensor4_unit, LV_SIZE_CONTENT);   /// 81
    lv_obj_set_height(ui_sensor4_unit, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_sensor4_unit, 0);
    lv_obj_set_y(ui_sensor4_unit, -5);
    lv_obj_set_align(ui_sensor4_unit, LV_ALIGN_BOTTOM_RIGHT);
    ...
    ui_sensor1_btn1 = lv_btn_create(ui_ha_sensors);
    lv_obj_set_width(ui_sensor1_btn1, 214);
    lv_obj_set_height(ui_sensor1_btn1, 80);
    lv_obj_set_x(ui_sensor1_btn1, 244);
