...
// SCREEN: ui_Alarm_keypad
void ui_Alarm_keypad_screen_init(void);
extern lv_obj_t * ui_Alarm_keypad;
extern lv_obj_t * ui_ha_keypad_label;
...
LV_IMG_DECLARE(ui_img_1091278663);    // assets/2023-11-13-19-59-31.png
...
LV_IMG_DECLARE(ui_img_round_png);    // assets/round.png
