...
void ui_ha_switches_screen_init(void)
{
    ...
    lv_obj_set_height(ui_Button, 80);
    ...
    lv_obj_set_height(ui_toggle, 80);
    lv_obj_set_x(ui_toggle, 22);
    lv_obj_set_y(ui_toggle, 182);
    ...
    lv_obj_set_width(ui_toggle_btn, 89);
    lv_obj_set_height(ui_toggle_btn, 41);
    ...
    lv_obj_set_height(ui_slider, 80);
    ...
    lv_obj_set_y(ui_slider_label, -2);
    ...
    lv_obj_set_x(ui_slider_data, -49);
    lv_obj_set_y(ui_slider_data, -2);
    lv_obj_set_align(ui_slider_data, LV_ALIGN_TOP_RIGHT);
    ...
    lv_obj_set_style_text_font(ui_slider_data, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_slider_unit, -2);
    lv_obj_set_y(ui_slider_unit, -2);
    lv_obj_set_align(ui_slider_unit, LV_ALIGN_TOP_RIGHT);
    ...
    lv_obj_set_style_text_font(ui_slider_unit, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_slider_btn, 173);
    lv_obj_set_height(ui_slider_btn, 16);
    lv_obj_set_x(ui_slider_btn, 0);
    lv_obj_set_y(ui_slider_btn, 18);
    ...
    lv_obj_set_height(ui_dropdown, 80);
    lv_obj_set_x(ui_dropdown, 22);
    lv_obj_set_y(ui_dropdown, 354);
    ...
    lv_dropdown_set_options(ui_dropdown_btn,
                            "Option 1\nOption 2\nOption 3\nOption 4\nOption 1\nOption 1\nOption 2\nOption 3\nOption 4\nOption 2\nOption 3\nOption 4");
    lv_obj_set_width(ui_dropdown_btn, 150);
    lv_obj_set_height(ui_dropdown_btn, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_dropdown_btn, 0);
    lv_obj_set_y(ui_dropdown_btn, 12);
    ...
    lv_obj_set_style_text_color(lv_dropdown_get_list(ui_dropdown_btn), lv_color_hex(0xC3C3C3),
                                LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(lv_dropdown_get_list(ui_dropdown_btn), 255,  LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(lv_dropdown_get_list(ui_dropdown_btn), lv_color_hex(0x4F4F4F),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(lv_dropdown_get_list(ui_dropdown_btn), 255,  LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(lv_dropdown_get_list(ui_dropdown_btn), lv_color_hex(0x2F2F2F),
                                  LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(lv_dropdown_get_list(ui_dropdown_btn), 255,  LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_set_style_bg_color(lv_dropdown_get_list(ui_dropdown_btn), lv_color_hex(0x529D53),
    ...
    lv_obj_set_x(ui_dropdown_label, 0);
    lv_obj_set_y(ui_dropdown_label, -12);
    lv_obj_set_align(ui_dropdown_label, LV_ALIGN_TOP_MID);
    ...
    lv_obj_set_width(ui_arc_btn, 71);
    lv_obj_set_height(ui_arc_btn, 70);
    lv_obj_set_x(ui_arc_btn, 1);
    lv_obj_set_y(ui_arc_btn, 5);
    lv_obj_set_align(ui_arc_btn, LV_ALIGN_RIGHT_MID);
    ...
    lv_obj_set_x(ui_arc_data, -87);
    lv_obj_set_y(ui_arc_data, -15);
    lv_obj_set_align(ui_arc_data, LV_ALIGN_BOTTOM_RIGHT);
    lv_label_set_text(ui_arc_data, "9999");
    ...
    lv_obj_set_style_text_align(ui_arc_data, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_arc_data, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);
